  ...
  if (req.method === "GET") {
    try {
      const result = await query({
        query: `SELECT t1.product_rel_id as id, t2.name as product, t6.shift_name as shift, t3.screen_name as screen, t4.instruction_img as opl, t5.parts_name as parts, t7.name as client_name FROM product_rel as t1 
      ...
      if (result.length > 0) {
        ...
        sendRes(res, true, 200, "No Record Found", result, null);
      }
    } catch (error) {
      console.log(error);
